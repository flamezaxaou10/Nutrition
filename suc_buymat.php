<body onLoad="window.print(window.location='insert_buymaterial.php')">
  <?php
include ('conn.php');
$id=$_GET['id'];
?>
  <h4 align=center>ใบสั่งซื้อวัตถุดิบ</h4>
...
$result  = mysql_query($sql);
  $strSQL = "SELECT * FROM `buymeterial` a,sys_user b,restaurant c WHERE a.user_name=b.username and a.res_name=c.res_name  AND typebuy= '1' AND id_mat='$id' order by date desc";
  $objQuery = mysql_query($strSQL,$connect1) or die("Error Query [".$strSQL."]");
  while ($objReSult = mysql_fetch_array($objQuery)) {
    ...
    <div style="page-break-after: always">
         ...
         while ($objReSult = mysql_fetch_array($objQuery)) {
           ...
           <tr>
             ...
             <td align=left><?php echo $objReSult["mat_name"]; ?></td>

...
<div class="container">
        ...
        <style media="screen">
         ...
         <table>
           ...
           <tr>
             ...
             <td style="padding-bottom:0px;"><h4>&nbsp;&nbsp; : &nbsp;&nbsp;</h4></td>
             <td style="padding-bottom:0px;"><h4> <input type="text" name="customer" value="<?php echo $row['customer']; ?>">
                  <input type="submit" class="btn btn-success" name="" value="แก้ไข"></h4></td>
            </form>
            <?php
                if($_POST && isset($_POST['customer'])){
                  $customer = $_POST['customer'];
                  $update = "UPDATE sale_feed SET customer = '$customer' WHERE salefeed_id = '$salefeed_id'";
                  mysql_query($update,$connect1);
                  header("LOCATION:update_salefeed.php?salefeed_id=$salefeed_id");
                }
             ?>
           </tr>
           <tr>
  ...
  <div class="modal-footer">
      ...
      <a href="sale_feed.php"><button type="button" class="btn btn-danger" data-dismiss="modal">ย้อนกลับ</button></a>
  </div>
</div>
<!-- Modal -->
